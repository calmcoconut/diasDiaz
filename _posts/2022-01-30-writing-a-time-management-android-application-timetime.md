...
![home](../assets/images/writing-a-time-management-android-application-timetime/home.png){: width="250" }
...
![log](../assets/images/writing-a-time-management-android-application-timetime/logtime.png){: width="250" }
...
![activity](../assets/images/writing-a-time-management-android-application-timetime/activity.png){: width="250" }

![create activity](../assets/images/writing-a-time-management-android-application-timetime/createActivity.png){: width="250" }

![category](../assets/images/writing-a-time-management-android-application-timetime/category.png){: width="250" }



Finally, A statistics page aggregates the user's database and presents data visualizations.

![stats period](../assets/images/writing-a-time-management-android-application-timetime/statperiod.png){: width="250" }

![stats](../assets/images/writing-a-time-management-android-application-timetime/statpage.png){: width="250" }
